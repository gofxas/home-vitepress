...
- `一位字母`: 区分系列，`S` - Galaxy S (S22 之后)，`G` - Galaxy S (S5-S21)，`N` - Galaxy Note，`F` - Galaxy Z，`A` - Galaxy A，`M` - Galaxy M，`E` 或 `F` - Galaxy F，`C` - Galaxy C，`J` - Galaxy J，`T` `X` - Galaxy Tab，`R` - Galaxy Watch
...
- Galaxy Note/Z Fold/Z Flip/Watch 等系列，系列名与数字之间无空格
